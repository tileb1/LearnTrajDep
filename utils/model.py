...
class TimeInceptionModule(nn.Module):
    def __init__(self):
        super().__init__()
        self.observed_length = [5, 5, 10, 10, 15, 15]
        self.convolutions = nn.ModuleList([])
        ...
        # 10
        self.convolutions.append(Conv1Channel(nb_filters=4, filter_size=2))
        self.convolutions.append(Conv1Channel(nb_filters=3, filter_size=3))
